...
if ( empty( $_GET ) && end( ( explode( '/' , trim($_SERVER['REQUEST_URI'], '/') ) ) ) == 'arteza-wp-setup' ) {
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Arteza Client WP Setup</title>
		<!-- Get out Google! -->
	...
	<h1 id="logo"><a href="http://www.artezacreative.com">Wordpress Setup</a></h1>
		<?php
		...
		if ( is_writable( $parent_dir ) ) { ?>
			...
			<form method="post" action="">
				...
				<p><?php echo _('This file must be in the arteza-wp-setup folder and not be present in the root of your project.');?></p>
